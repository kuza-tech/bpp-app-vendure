...
import { MyConnectSdk } from '../payment/cs-connect-sdk';

const sdk = new MyConnectSdk({ apiKey: 'MY_API_KEY' });

export const createSellerPaymentMethodHandler = new PaymentMethodHandler({
    code: 'cs-connect-payment-method',
    description: [
        {
            languageCode: LanguageCode.en,
            value: 'Create Seller Payment Provider',
        },
    ],
    args: {},
